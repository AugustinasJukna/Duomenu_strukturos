...
public class ManualTest {
    ...
    static void testStack(Stack<Car> stack) {
        System.out.println();
        stack.push(new Car("Test", "Test1", 1997, 1000, 700));
        stack.push(new Car("Test", "Test2", 1996, 500, 800));
        stack.push(new Car("Test", "ToRemove(Test3)", 2000, 1000, 1000));
        System.out.println("Popped car: " + stack.pop().toString());
        System.out.println("Ar sąrašas yra tuščias?");
        System.out.println(stack.isEmpty());
        System.out.println("Pirmo elemento grąžinimas (po \"pop\"): " + stack.peak());

    }

    static void testQueue(Queue<Car> queue) {
        System.out.println();
        queue.enqueue(new Car("Test", "Test1", 1997, 1, 900));
        queue.enqueue(new Car("Test", "Test2", 1997, 1, 500));
        queue.enqueue(new Car("Test", "Test3", 1995, 1, 8900));
        queue.enqueue(new Car("Test", "Test4", 1996, 1, 1000));
        System.out.println("Dequeue: " + queue.dequeue().toString());
        System.out.println("Ar sąrašas yra tuščias?");
        System.out.println(queue.isEmpty());
        System.out.println("Pirmo elemento grąžinimas (po \"dequeue\"): " + queue.peak());
        System.out.println("Pirmo elemento grąžinimas (po \"dequeue\"): " + queue.peak());
    }


    static void iteratorTest() {
        System.out.println("\nIteratoriaus remove metodo bandymai: ");
        LinkedList<Car> cars = new LinkedList<>();
        cars.add(new Car("", "Test1", 1997, 10, 500));
        cars.add(new Car("", "Test2", 1997, 10, 600));
        cars.add(new Car("", "Test3", 1997, 10, 400));
        cars.add(new Car("", "Test4", 1997, 10, 1000));
        cars.add(new Car("", "Test5", 1997, 10, 1000));

        Iterator<Car> iterator = cars.iterator();
        while (iterator.hasNext()) {
            Car car = iterator.next();
            System.out.println("Cars test " + car.getModel());
            if (car.getModel().equals("Test1")) {
                iterator.remove();
            }
            if (car.getModel().equals("Test4")) {
                iterator.remove();
            }
//            if (car.getModel().equals("Test5")) {
//                iterator.remove();
//            }
